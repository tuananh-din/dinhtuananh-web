...
<div class="main-content">
    <div class="page-header">
        <h2 class="header-title">Ch&#7881;nh s&#7917;a kh&#243;a h&#7885;c</h2>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="content" class="form-control" rows="8">{{ old('content', $course->content) }}</textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" min="0" name="sale_price" class="form-control" value="{{ old('sale_price', $course->sale_price) }}">
                                </div>
                                <div class="form-group">
                                    <label>N&#7873;n t&#7843;ng</label>
                                    <input type="text" name="platform" class="form-control" value="{{ old('platform', $course->platform) }}">
                                </div>
                                <div class="form-group">
                                    <label>C&#7845;p &#273;&#7897;</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="format" class="form-control" value="{{ old('format', $course->format) }}">
                                </div>
                                <div class="form-group">
                                    <label>CTA text</label>
                                    <input type="text" name="cta_text" class="form-control" value="{{ old('cta_text', $course->cta_text) }}">
                                </div>
                                <div class="form-group">
                                    <label>CTA link</label>
                                    <input type="text" name="cta_link" class="form-control" value="{{ old('cta_link', $course->cta_link) }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="seo_title" class="form-control" value="{{ old('seo_title', $course->seo_title) }}">
                                </div>
                                <div class="form-group">
                                    <label>SEO description</label>
                                    <textarea name="seo_description" class="form-control" rows="4">{{ old('seo_description', $course->seo_description) }}</textarea>
                                </div>
