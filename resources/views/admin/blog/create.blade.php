                            ...
                            <div class="card-body">
                                ...
                                <p class="card-description"> Thông tin chi tiết </p>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="border rounded p-3">
                                            ...
                                            <div class="form-check">
                                                <input id="category-{{ $category->id }}" class="form-check-input" type="checkbox" name="categories[]" value="{{ $category->id }}" {{ in_array($category->id, old('categories', [])) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check mb-3">
                                        <input id="is_published" class="form-check-input" type="checkbox" name="is_published" value="1" {{ old('is_published', true) ? 'checked' : '' }}>
